...
export const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full glass-effect border-b border-slate-200/80 shadow-sm">
      ...
      <div className="bg-emerald-950 text-emerald-100 text-[11px] font-semibold py-1.5 px-4 flex items-center justify-between sm:justify-center gap-2 border-b border-emerald-900">
      ...
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="hidden sm:flex items-center gap-1.5 text-xs font-bold text-slate-700 hover:text-emerald-800 bg-slate-100 hover:bg-emerald-50 px-3 py-2 rounded-xl transition-all border border-slate-200/80 shadow-xs"
          >
