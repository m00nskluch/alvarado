...
const PRODUCT_ID = '187824c4-fb27-46bd-a25c-54680b0d442c';
const PRODUCT_NAME = 'Brochetas de Madera Vara 30 cm';
const CATEGORY = 'plasticos';
const SOURCE_IMAGE_URL = 'https://media.diy.com/is/image/KingfisherDigital/100-bamboo-bbq-skewers-30cm-long-wooden-kebab-sticks-for-bbq-grill-meat-veg-fruit-strong-natural-bamboo~5060478364740_01c_MP?$MOB_PREV$&$width=1200&$height=1200';
...
async function replaceImage() {
  ...
  const newLogEntry = {
    ...
    rejection_reason: 'Foto previa mostraba marca/diseño de competidor (bambú verde visible)',
